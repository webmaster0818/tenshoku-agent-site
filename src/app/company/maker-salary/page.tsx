...
export const metadata: Metadata = {
  title: "メーカーの年収ランキング【2026年・有価証券報告書】大手16社を一次データで比較",
  description:
    "大手メーカーの平均年収を有価証券報告書の記載値（決算期明記）でランキング。キーエンス2,178万円・東京エレクトロン1,380万円・ソニーグループ1,155万円・ファナック1,144万円・トヨタ自動車1,006万円ほかFA/半導体/電機/自動車/精密/食品/家電の16社。持株会社単体と事業会社の違い、中途採用の入口、転職難易度まで一次データで解説します。",
  openGraph: {
    title: "メーカーの年収ランキング【2026年・有価証券報告書】",
    description: "大手メーカー16社の平均年収を有報記載値でランキング。転職難易度も解説。",
  },
};
...
const ranking = [
  ...
  { rank: 13, slug: "zojirushi", name: "象印マホービン", salary: "約835万円", term: "2025年11月期", note: "炊飯ジャー・ステンレスボトルで知られる大阪の生活家電メーカー。単体527名規模で家電メーカーとして高めの水準", hd: false, field: "家電" },
  { rank: 14, slug: "nidec", name: "ニデック", salary: "約760万円", term: "2025年3月期", note: "精密小型モーターで世界首位。旧・日本電産。M&Aで事業領域を広げる、車載・家電・産業向けの総合モーターメーカー", hd: false, field: "精密・モーター" },
  { rank: 15, slug: "toyo-suisan", name: "東洋水産", salary: "約698万円", term: "2026年3月期", note: "「マルちゃん」ブランドの即席麺大手。北米の即席麺事業（Maruchan）が成長ドライバー。平均勤続が長い長期雇用型", hd: false, field: "食品" },
  { rank: 16, slug: "muji", name: "良品計画（無印良品）", salary: "約670万円", term: "2025年8月期", note: "「無印良品」を展開する製造小売（SPA）。企画・生産管理から店舗運営まで担う。他のメーカーとは事業構造が異なる", hd: false, field: "製造小売" },
];

const faqData = [
  {
    q: "メーカーで平均年収が一番高いのはどこですか？",
    a: "当サイトが有価証券報告書で確認した大手16社では、キーエンスが約2,178万円（2026年3月期）で最も高く、東京エレクトロン約1,380万円・ソニーグループ約1,155万円・ファナック約1,144万円が続きます。キーエンスは平均年齢35.0歳と若く成果連動の性格が強い点、ソニーグループの数値は持株会社単体（本社機能スタッフ中心）の平均である点など、数値の背景もあわせて確認するのがおすすめです。",
  },
  {
      ...
      <article className="prose-custom max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <div className="bg-warm-gray rounded-2xl p-6 sm:p-8 mb-10">
          ...
          <p className="text-text-secondary leading-relaxed">
            大手メーカー16社の平均年収を、有価証券報告書の記載値（平均年間給与・決算期明記）だけでランキングしました。ネット上に多い「推定年収」ではなく、各社がEDINETに提出した一次データにもとづく数値です。FA・半導体・電機・自動車・精密・化学・電子部品・食品・家電まで、持株会社単体と事業会社の違い、中途採用の入口もあわせて解説します。
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-8">
          ...
          <div className="card-hover p-5">
            ...
            <p className="text-xs text-text-secondary leading-relaxed">タカラトミーのように業績好調で平均給与が上昇する例があり、決算期の併記を確認しましょう。16社の決算期は同一ではありません。</p>
          </div>
        </div>
