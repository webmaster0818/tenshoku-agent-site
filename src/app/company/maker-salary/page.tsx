...
export const metadata: Metadata = {
  title: "メーカーの年収ランキング【2026年・有価証券報告書】大手29社を一次データで比較",
  description:
    "大手メーカーの平均年収を有価証券報告書の記載値（決算期明記）でランキング。キーエンス2,178万円・ディスコ1,879万円・レーザーテック1,681万円・東京エレクトロン1,380万円・トヨタ自動車1,006万円ほかFA/半導体/電機/自動車/精密/食品/家電の29社。持株会社単体と事業会社の違い、中途採用の入口、転職難易度まで一次データで解説します。",
  openGraph: {
    title: "メーカーの年収ランキング【2026年・有価証券報告書】",
    description: "大手メーカー29社の平均年収を有報記載値でランキング。転職難易度も解説。",
  },
};
...
const ranking = [
  ...
  { rank: 15, slug: "yakult", name: "ヤクルト本社", salary: "約854万円", term: "2026年3月期", note: "平均勤続約17.7年と非常に長い安定雇用型。乳酸菌飲料の国内に加え、アジア・米州の海外事業が利益の柱", hd: false, field: "食品・飲料" },
  { rank: 16, slug: "murata", name: "村田製作所", salary: "約838万円", term: "2026年3月期", note: "積層セラミックコンデンサ（MLCC）で世界シェア首位級。スマホ・車載向けを支える京都の電子部品大手", hd: false, field: "電子部品" },
  { rank: 17, slug: "casio", name: "カシオ計算機", salary: "約838万円", term: "2026年3月期", note: "G-SHOCK等の時計・電卓・電子辞書・電子楽器のメーカー。前期814万円から上昇。単体2,053名", hd: false, field: "時計・電機" },
  { rank: 18, slug: "zojirushi", name: "象印マホービン", salary: "約835万円", term: "2025年11月期", note: "炊飯ジャー・ステンレスボトルで知られる大阪の生活家電メーカー。単体527名規模で家電メーカーとして高めの水準", hd: false, field: "家電" },
  { rank: 19, slug: "yamaha-motor", name: "ヤマハ発動機", salary: "約835万円", term: "2025年12月期", note: "二輪車で世界大手。12月決算。楽器・音響のヤマハ(7951)とは別法人である点に注意(資本関係はあるが上場企業として独立)", hd: false, field: "輸送機器(二輪)" },
  { rank: 20, slug: "tokyo-seimitsu", name: "東京精密", salary: "約828万円", term: "2026年3月期", note: "ウェーハプローバ・ダイシングなど半導体計測/加工装置。平均年間給与は過去12年で最高を更新", hd: false, field: "半導体計測・加工装置" },
  { rank: 21, slug: "pigeon", name: "ピジョン", salary: "約827万円", term: "2025年12月期", note: "哺乳器・育児用品の国内大手。単体338名と少人数で、製造等はグループ会社が担うため本社単体（本社機能中心）の平均である点に注意", hd: false, field: "育児用品" },
  { rank: 22, slug: "brother", name: "ブラザー工業", salary: "約805万円", term: "2026年3月期", note: "プリンター・複合機を軸に工作機械・ミシンまで持つ名古屋の総合機器メーカー。単体3,997名", hd: false, field: "電機・機械" },
  { rank: 23, slug: "rohm", name: "ローム", salary: "約804万円", term: "2026年3月期", note: "京都本社の半導体メーカー。パワー半導体・カスタムLSIが主力。SiCパワー半導体への投資を拡大", hd: false, field: "半導体(パワー・LSI)" },
  { rank: 24, slug: "yamaha", name: "ヤマハ", salary: "約794万円", term: "2026年3月期", note: "楽器で世界首位級・音響機器も展開する浜松のメーカー。平均勤続18.1年の長期雇用型。ヤマハ発動機（7272）は別法人", hd: false, field: "楽器・音響" },
  { rank: 25, slug: "citizen", name: "シチズン時計", salary: "約789万円", term: "2026年3月期", note: "事業持株会社の単体770名（本社機能中心）の値で、製造子会社の従業員は含まれない点に注意。2021年3月期593万円から上昇傾向", hd: true, field: "時計" },
  { rank: 26, slug: "nidec", name: "ニデック", salary: "約760万円", term: "2025年3月期", note: "精密小型モーターで世界首位。旧・日本電産。M&Aで事業領域を広げる、車載・家電・産業向けの総合モーターメーカー", hd: false, field: "精密・モーター" },
  { rank: 27, slug: "toyo-suisan", name: "東洋水産", salary: "約698万円", term: "2026年3月期", note: "「マルちゃん」ブランドの即席麺大手。北米の即席麺事業（Maruchan）が成長ドライバー。平均勤続が長い長期雇用型", hd: false, field: "食品" },
  { rank: 28, slug: "calbee", name: "カルビー", salary: "約685万円", term: "2026年3月期", note: "ポテトチップス・じゃがりこの菓子大手。2026年3月期に工場の無期契約社員を正社員等級へ統合し単体+1,421名となった影響で平均値が変動（待遇引き下げではない）", hd: false, field: "食品" },
  { rank: 29, slug: "muji", name: "良品計画（無印良品）", salary: "約670万円", term: "2025年8月期", note: "「無印良品」を展開する製造小売（SPA）。企画・生産管理から店舗運営まで担う。他のメーカーとは事業構造が異なる", hd: false, field: "製造小売" },
];

const faqData = [
  {
    q: "メーカーで平均年収が一番高いのはどこですか？",
    a: "当サイトが有価証券報告書で確認した大手29社では、キーエンスが約2,178万円（2026年3月期）で最も高く、ディスコ約1,879万円・レーザーテック約1,681万円・東京エレクトロン約1,380万円が続きます（半導体関連が上位を占めます）。キーエンスは平均年齢35.0歳と若く成果連動の性格が強い点、ソニーグループの数値は持株会社単体（本社機能スタッフ中心）の平均である点など、数値の背景もあわせて確認するのがおすすめです。",
  },
  {
      ...
      <article className="prose-custom max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <div className="bg-warm-gray rounded-2xl p-6 sm:p-8 mb-10">
          ...
          <p className="text-text-secondary leading-relaxed">
            大手メーカー29社の平均年収を、有価証券報告書の記載値（平均年間給与・決算期明記）だけでランキングしました。ネット上に多い「推定年収」ではなく、各社がEDINETに提出した一次データにもとづく数値です。FA・半導体・電機・自動車・精密・化学・電子部品・食品・家電まで、持株会社単体と事業会社の違い、中途採用の入口もあわせて解説します。
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-8">
          ...
          <div className="card-hover p-5">
            ...
            <p className="text-xs text-text-secondary leading-relaxed">タカラトミーのように業績好調で平均給与が上昇する例があり、決算期の併記を確認しましょう。29社の決算期は同一ではありません。</p>
          </div>
        </div>
