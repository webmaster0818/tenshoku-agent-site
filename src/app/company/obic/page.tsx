...
const faqData = [
  ...
  },
  {
    ...
    "a": "2026年7月31日時点で、公式採用サイトに掲載されている採用区分は新卒採用とインターンシップのみで、中途採用（キャリア採用）の常設窓口は確認できませんでした。中途採用の実施有無は公式サイト上に明記されていないため、最新の募集状況は公式採用ページの更新をご確認ください。"
  },
  {
    "q": "オービックの転職難易度は高いですか？",
    ...
    <>
      ...
      <article className="prose-custom max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <div className="glass-card p-6 mb-8">
          ...
          <ul className="space-y-2 text-sm text-text-secondary">
            <li>公式採用ページに掲載されている採用区分は「新卒採用」と「インターンシップ」のみ（2026年7月31日確認）。中途採用（キャリア採用）専用ページは確認できず。</li>
            <li>公式サイトの「career」ページ（www.obic.co.jp/career/）は社員のキャリア紹介コンテンツ「私たちのキャリアレポート」であり、中途採用の募集ページではない点に注意。</li>
            <li>採用に関する問い合わせ窓口としては人事部の連絡先が公式に記載されている。</li>
