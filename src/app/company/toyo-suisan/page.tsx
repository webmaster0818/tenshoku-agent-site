...
export const metadata: Metadata = {
  ...
  description:
    "東洋水産（証券コード2875）への転職を有価証券報告書などの一次データで解説。平均年間給与は約698万円（2026年3月期・有報／提出会社）。中途採用の状況、求められる人材、選考フロー、年収の考え方をまとめました。",
  openGraph: {
    title: "東洋水産への転職は難しい？中途採用・平均年収・選考を徹底解説【2026年】",
    description: "東洋水産（2875）の平均年収・中途採用・選考フローを有価証券報告書ベースで解説。",
  },
};
...
const faqData = [
  {
    "q": "東洋水産の平均年収はいくらですか？",
    "a": "有価証券報告書によると平均年間給与は約698万円（2026年3月期・単体）です。食品メーカーとしては標準〜やや高めの水準で、職種により実際のレンジは異なります。"
  },
  {
    "q": "東洋水産は中途採用を行っていますか？",
  ...
  {
    "q": "東洋水産の転職難易度は高いですか？",
    "a": "国民的ブランドを持つ安定企業で長期雇用型のため、中途の募集枠は大手食品の中でも多くはありません。食品・製造業での専門経験を持つ方が有利です。"
  },
  {
    "q": "「マルちゃん」と会社の関係は？",
    "a": "「マルちゃん」は東洋水産の主力ブランドで、即席麺・チルド麺などに使われています。北米でも「Maruchan」ブランドで即席麺事業を展開しています。"
  },
  {
    "q": "勤務地はどこですか？",
    "a": "本社は東京都港区。全国の工場・支店勤務の職種もあり、応募ポジションにより異なります。"
  },
  {
    "q": "定着率は高いですか？",
    "a": "有報の平均勤続年数は約16.8年（2026年3月期）と、上場企業の中でも長い部類です。長く働く社員が多い企業文化がうかがえます。"
  }
];
      ...
      <article className="prose-custom max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <div className="glass-card p-6 mb-8">
          <ul className="space-y-2 text-sm text-text-secondary">
            ...
            <li>平均勤続約16.8年と長く、定着率の高さがうかがえるのが特徴。</li>
            <li>「マルちゃん」の国民的知名度に加え、北米即席麺事業（Maruchan）が成長ドライバー。</li>
        ...
        <div className="overflow-x-auto mb-4">
          <table className="w-full text-sm border-collapse">
            <tbody>
              {[
                { label: "社名", value: "東洋水産" },
                { label: "証券コード", value: "2875（東証プライム）" },
                { label: "本社", value: "東京都港区" },
                { label: "事業内容", value: "「マルちゃん」ブランドの即席麺・加工食品・水産食品の製造・販売（海外即席麺事業が成長ドライバー）" },
                { label: "平均年間給与", value: "約698万円（2026年3月期・有価証券報告書／提出会社）" },
                { label: "平均年齢", value: "約41.7歳（同・提出会社）" },
                { label: "平均勤続年数", value: "約16.8年（同・提出会社）" },
                { label: "従業員数", value: "2,192名（同・提出会社単体）／連結は要公式確認" },
              ].map((row) => (
        ...
        <div className="glass-card p-6 mb-8">
          ...
          <ul className="space-y-2 text-sm text-text-secondary">
            <li>掲載職種：開発・品質管理・分析（即席麺・チルド食品・加工食品・水産加工品等の研究開発、各種検査・分析等）／工務（設備導入、メンテナンス、工場ラインの構築や管理、生産設備開発や設計など。職務経験5年以上）／法務（契約関連、知的財産関連、法律相談、コンプライアンス研修など）／情報システム（システム企画・構築・運用・保守）。海外営業・海外事務・海外製造は「現在、募集はしておりません。」と明記（2026年7月31日確認時点）。</li>
            <li>勤務地は「全国（本社・各事業部・各工場・各支店・海外を含めた各関係会社）」。開発・品質管理・分析は当社研究所（群馬県館林市）・国内外各事業所（関係会社含む）。</li>
            <li>応募方法は、写真付き履歴書（直筆）と職務経歴書を本社「総務部人事課 採用担当」宛に郵送する方式（希望職種とメールアドレスを必記）。Web応募フォームではなく直筆・郵送応募という、今では珍しい形。</li>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-8">
          {[
            ...
            { title: "安定志向と着実さ", desc: "平均勤続16.8年という数字が示すように、腰を据えて長く働く文化との相性が問われます。" }
          ].map((point) => (
        ...
        <div className="glass-card p-6 mb-8">
          <ul className="space-y-2 text-sm text-text-secondary">
            ...
            <li>平均勤続16.8年・平均年齢41.7歳と長期雇用型のため、平均値は在籍年数の長さを反映している。</li>
        ...
        <div className="bg-navy rounded-2xl p-6 sm:p-8 text-center">
          <h2 className="text-xl font-extrabold text-white mb-3 border-none pb-0 mt-0">東洋水産転職を成功させるために</h2>
