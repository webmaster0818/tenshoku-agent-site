...
export const metadata: Metadata = {
  title: "半導体業界の年収ランキング【2026年・有価証券報告書】装置メーカー中心に9社を一次データで比較",
  description:
  ...
  openGraph: {
    ...
    description: "半導体装置メーカー中心に9社の平均年収を有報記載値でランキング。転職の入口も解説。",
  },
};
...
const ranking = [
  ...
  { rank: 9, slug: "renesas", name: "ルネサスエレクトロニクス", salary: "約749万円", term: "2025年12月期", note: "マイコン(MCU)中心の半導体デバイス大手。12月決算のため2025年12月期が最新確定値。889万→809万→749万円と直近3年は減少傾向で、装置メーカー群との差はデバイス市況の年度間変動も影響", hd: false, field: "半導体デバイス(マイコン)" },
];

const faqData = [
  {
    q: "半導体業界で平均年収が一番高いのはどこですか？",
    a: "当サイトが有価証券報告書で確認した9社では、ディスコが約1,879万円（2026年3月期）で最も高く、レーザーテック約1,681万円（2025年6月期）・東京エレクトロン約1,380万円（2026年3月期）が続きます。上位は半導体デバイスメーカーではなく、製造装置・検査装置のメーカーが占めています。ディスコの平均は賞与を含む数値で、有報に賞与が個人の成果に連動する仕組み（個人Will会計）の記載がある点など、数値の背景もあわせて確認するのがおすすめです。",
  },
  {
    q: "半導体業界の年収はなぜ高いのですか？",
  ...
  },
  {
    ...
    a: "今回の9社の有報値では、製造装置・検査装置のメーカー（ディスコ約1,879万円〜東京精密約828万円）が上位に多く、デバイス・部品のメーカー（村田製作所約838万円・ローム約804万円）が続く分布です。ただし各社で決算期・従業員構成（平均年齢・勤続年数・単体の範囲）が異なるため、装置かデバイスかだけで単純に優劣を判断できるものではありません。",
  },
  {
      ...
      <article className="prose-custom max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <div className="bg-warm-gray rounded-2xl p-6 sm:p-8 mb-10">
          ...
          <p className="text-text-secondary leading-relaxed">
            半導体業界9社（製造装置・検査装置・計測装置・電子部品・デバイス）の平均年収を、有価証券報告書の記載値（平均年間給与・決算期明記）だけでランキングしました。ネット上に多い「推定年収」や口コミの集計ではなく、各社がEDINETに提出した一次データにもとづく数値です。持株会社単体と事業会社の違い、年収が高い背景、中途採用の入口もあわせて解説します。
          </p>
        </div>
