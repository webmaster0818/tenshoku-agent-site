    ...
    <>
      ...
      <article className="prose-custom max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <figure className="mb-2 overflow-hidden rounded-2xl border border-border">
          <img src="/company-ss/dentsu-soken.jpg" alt="電通総研の公式サイト(スクリーンショット)" className="w-full h-auto" loading="lazy" />
        </figure>
        <p className="text-xs text-text-muted mb-6">電通総研 公式サイトのスクリーンショット(2026年9月16日取得)。最新の情報は公式サイトをご確認ください。</p>
        ...
        <nav id="auto-toc" className="mb-10 rounded-2xl border border-border bg-warm-gray/60 p-5 sm:p-6">
          ...
          <ol className="space-y-1.5 text-sm list-decimal pl-5">
            <li><a href="#s1" className="text-teal hover:underline">結論：電通総研転職のポイント</a></li>
            <li><a href="#s2" className="text-teal hover:underline">電通総研の基本データ（有価証券報告書）</a></li>
            <li><a href="#s3" className="text-teal hover:underline">電通総研の中途採用の状況</a></li>
            <li><a href="#s4" className="text-teal hover:underline">電通総研で求められる人材</a></li>
            <li><a href="#s5" className="text-teal hover:underline">電通総研の選考フロー（公式記載）</a></li>
            <li><a href="#s6" className="text-teal hover:underline">電通総研の年収の考え方</a></li>
            <li><a href="#s7" className="text-teal hover:underline">電通総研転職で活用したい転職エージェント</a></li>
            <li><a href="#s8" className="text-teal hover:underline">電通総研転職 よくある質問</a></li>
          </ol>
        </nav>

        <h2 id="s1">結論：電通総研転職のポイント</h2>
        ...
        <h2 id="s2">電通総研の基本データ（有価証券報告書）</h2>
        ...
        <h2 id="s7">電通総研転職で活用したい転職エージェント</h2>
