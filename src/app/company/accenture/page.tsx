...
const faqData = [
  ...
  },
  {
    ...
    a: "有価証券報告書の開示対象外のため公式な平均給与はありませんが、社員クチコミ（OpenWork）の回答者平均は875万円（ストラテジー約1,495万・コンサルタント約955万・エンジニア/SE約652万・アナリスト約578万）です。ポジションにより異なりますが、アナリスト（新卒・第二新卒）で430〜500万円、コンサルタントで500〜700万円、マネージャーで800〜1,200万円、シニアマネージャー以上で1,200〜1,500万円以上が目安です。",
  },
  {
