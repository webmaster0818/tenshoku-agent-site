...
const faqData = [
  ...
  {
    "q": "カルビーは中途採用を行っていますか？",
    "a": "公式FAQでは「既卒（中途）採用に関するお問合せを受け付けておりません」と案内されており、公式サイトからの中途直接応募窓口は確認できません（2026年7月31日確認時点）。中途の求人は求人サイト等に掲載されることがあり、掲載元の採用エージェント経由での応募が公式に案内されたルートです。"
  },
  {
    "q": "カルビーの転職難易度は高いですか？",
  ...
  },
  {
    ...
    "a": "本体の公式サイトには中途向けの募集職種は掲載されていません（2026年7月31日確認時点）。中途求人は求人サイト等の掲載元・エージェント経由で確認する形で、募集の有無・職種は時期により変動します。"
  },
  {
    "q": "勤務地はどこですか？",
    ...
    <>
      ...
      <article className="prose-custom max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <div className="glass-card p-6 mb-8">
          ...
          <ul className="space-y-2 text-sm text-text-secondary">
            <li>公式サイトからの中途直接応募・問い合わせは不可。求人サイト等の掲載元エージェント経由が公式FAQで案内された応募方法。</li>
            <li>本体公式サイトには中途向けの募集職種・勤務地の掲載なし（2026年7月31日確認時点）。求人内容は掲載元の求人サイト・エージェントで確認する形。</li>
            <li>グループ会社には別途公式キャリア採用ページあり。カルビーポテトは確認時点で「現在募集している職種はありません」、カルビーロジスティクスは本体とは別法人のため参考。</li>
