...
export const metadata: Metadata = {
  ...
  description:
    "総合商社の平均年収を有価証券報告書の記載値（2026年3月期）でランキング。三菱商事2,112万円・三井物産2,058万円・伊藤忠商事1,991万円・住友商事1,840万円・丸紅1,784万円の5大商社に、豊田通商・双日・兼松を加えた9社。全従業員平均の意味、キャリア採用の入口まで一次データで解説します。",
  openGraph: {
    title: "総合商社の年収ランキング【2026年・有価証券報告書】",
    description: "7大商社+専門商社9社の平均年収を有報記載値でランキング。キャリア採用の入口も解説。",
  },
};
...
const ranking = [
  ...
  { rank: 9, slug: "hanwa", name: "阪和興業", salary: "約997万円", term: "2026年3月期", note: "鉄鋼流通の独立系最大手。平均37.4歳の最年少構成で2年間に計148万円上昇し1,000万円目前", hd: false, field: "専門商社" },
];
...
const faqData = [
  ...
  },
  {
    ...
    a: "9社とも公式のキャリア採用サイト(または採用ポータル)で募集ポジションを公開しています(2026年9月5日確認)。加えて商社は非公開求人・スカウト経由の採用も多いため、ハイクラス向けエージェントやスカウト型サービスの併用が実質的な入口になります。",
  },
];
