...
export const metadata: Metadata = {
  ...
  description:
    'フューチャー（証券コード4722）への転職を有価証券報告書などの一次データで解説。平均年間給与は約794万円（2025年12月期・有報／提出会社）。中途採用・求められる人材・年収の考え方をまとめました。',
  openGraph: {
    title: 'フューチャーへの転職は難しい？中途採用・平均年収・選考を徹底解説【2026年】',
    description: "フューチャーの平均年収・中途採用・選考を有価証券報告書ベースで解説。",
  },
};

const faqData = [
  {
    "q": 'フューチャーの平均年収はいくらですか？',
    "a": '有価証券報告書によると平均年間給与は約794万円（2025年12月期・提出会社）です。ITコンサル/SI業界としては高水準で、等級・役職により実レンジは変わります。'
  },
  {
    "q": 'フューチャーは中途採用を行っていますか？',
    "a": 'はい。コンサルタント・エンジニア等の職種でキャリア採用が活発です。募集状況は時期により変動するため、公式採用サイトでご確認ください。'
  },
  {
    "q": 'フューチャーの転職難易度は高いですか？',
    "a": '人気企業のため選考の競争はありますが、コンサル/IT/特定ドメインの実務経験があれば十分にチャンスがあります。等級ごとに求められる水準が異なります。'
  },
  {
    "q": 'フューチャーの平均年齢・勤続年数は？',
    "a": '有報では平均年齢約36.5歳・平均勤続約6.0年（2025年12月期）です。'
  },
  {
    "q": '未経験から転職できますか？',
      ...
      <article className="prose-custom max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <div className="glass-card p-6 mb-8">
          <ul className="space-y-2 text-sm text-text-secondary">
            ...
            <li>平均勤続約6.0年・平均年齢36.5歳。</li>
            <li>ITコンサルタント・アーキテクト・エンジニアを通年で中途採用。</li>
            <li>上流から実装まで携わる文化のため、技術力と提案力の両輪が評価される。</li>
          </ul>
        </div>
        ...
        <div className="overflow-x-auto mb-4">
          <table className="w-full text-sm border-collapse">
            <tbody>
              {[
                { label: "社名", value: 'フューチャー' },
                { label: "証券コード", value: '4722（東証プライム）' },
                { label: "本社", value: '東京都品川区' },
                { label: "事業内容", value: 'ITコンサルティングとシステム開発を一体提供する独立系IT企業' },
                { label: "平均年間給与", value: "約794万円（2025年12月期・有価証券報告書／提出会社）" },
                { label: "平均年齢", value: "約36.5歳（同・提出会社）" },
                { label: "平均勤続年数", value: "約6.0年（同・提出会社）" },
                { label: "従業員数", value: "377名（同・提出会社単体）／連結は要公式確認" },
              ].map((row) => (
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-8">
          {[
          {
            title: '上流〜実装の両方の経験', desc: '要件定義・設計から実装までを担うため、幅広い経験が活きます。',
          },
          {
            title: '技術的な引き出し', desc: 'アーキテクチャ設計や新技術の適用力が評価されます。',
          },
          {
            title: '課題解決志向', desc: '顧客の経営課題をITで解く姿勢が求められます。',
          },
          {
            title: '自走力', desc: '裁量が大きい分、自律的に動ける力が問われます。',
          },
          ].map((point) => (
        ...
        <div className="bg-navy rounded-2xl p-6 sm:p-8 text-center">
          <h2 className="text-xl font-extrabold text-white mb-3 border-none pb-0 mt-0">フューチャー転職を成功させるために</h2>
        ...
        <div className="mt-10 pt-8 border-t border-border">
          ...
          <div className="flex flex-col sm:flex-row gap-3 flex-wrap">
            ...
            <Link href="/company/shift/" className="btn-primary text-sm px-5 py-2.5 bg-navy-light">SHIFT転職ガイド</Link>
