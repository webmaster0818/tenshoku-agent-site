...
const faqData = [
  ...
  { q: "女性向けの転職エージェントは1社だけで十分ですか？", a: "2〜3社の併用が一般的です。求人数が業界最大級のリクルートエージェントやdodaで選択肢を広げつつ、20代・第二新卒なら手厚いマイナビエージェント、管理職・ハイクラス志向ならビズリーチやJACリクルートメントを組み合わせると、ライフプランに合った求人を比較しやすくなります。" },
      ...
      <article className="prose-custom max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <div className="bg-teal/5 rounded-2xl p-5 sm:p-6 mb-10 border border-teal/15">
          ...
          <ul className="space-y-2 text-sm text-text-secondary">
            ...
            <li className="flex items-start gap-2">
              <span className="text-teal mt-0.5 flex-shrink-0">&#10003;</span>
              <span><strong>管理職・ハイクラス志向なら<Link href="/review/bizreach/" className="text-teal underline">ビズリーチ</Link>・<Link href="/review/jac/" className="text-teal underline">JACリクルートメント</Link></strong>。スカウトで自分の市場価値を確認できます。</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-teal mt-0.5 flex-shrink-0">&#10003;</span>
        ...
        <div className="space-y-4 mb-10">
          {[
            ...
            { rank: 5, name: "JACリクルートメント", href: "/review/jac/", desc: "外資系企業や日系グローバル企業の求人に強く、ダイバーシティに積極的な企業の求人が多い傾向があります。ハイクラスを目指す女性にも向いています。" },
          ].map((agent) => (
        ...
        <div className="space-y-4 mb-8">
          {[
            ...
            { point: "年代・志向に合うサービスを選ぶ", desc: "20代・第二新卒は手厚いマイナビエージェント、管理職・ハイクラス志向はビズリーチ・JACリクルートメントなど、自分のフェーズに合うサービスを軸にしましょう。" },
          ].map((item, i) => (
