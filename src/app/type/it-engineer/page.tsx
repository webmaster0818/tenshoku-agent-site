...
const faqData = [
  ...
  { q: "ITエンジニアの転職で年収は上がりますか？", a: "スキルと市場価値次第ですが、需要の高い言語・クラウド・上流工程の経験があれば好条件の求人に出会いやすくなります。エージェントは非公開求人や提示年収の交渉を代行してくれるため、複数社で想定年収レンジを把握してから動くのがおすすめです。" },
      ...
      <article className="prose-custom max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <div className="bg-warm-gray rounded-2xl p-6 sm:p-8 mb-10">
          ...
          <p className="text-text-secondary leading-relaxed">
            ITエンジニアの転職は需要が高く、スキル次第でキャリアの選択肢が大きく広がります。
            ここでは、IT・エンジニア求人に強い転職エージェントを厳選し、キャリア別の選び方とあわせて紹介します。
          </p>
        </div>
        ...
        <div className="space-y-4 mb-10">
          {[
            ...
            { rank: 4, name: "ビズリーチ", href: "/review/bizreach/", desc: "スカウト型で、スキルの高いエンジニアに企業・ヘッドハンターから直接オファーが届きます。ハイクラス転職を狙うエンジニアにおすすめです。" },
        ...
        <div className="space-y-5 mb-8">
          {[
            ...
            { step: 2, title: "目的で使い分ける", desc: "ハイクラス志向ならビズリーチやJAC、未経験・若手ならマイナビ、というように目的に合うエージェントを選びましょう。" },
